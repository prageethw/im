...
_Regenerated from latest running dump: `new-context-working-v29.md`._
...
## IntentAssuranceEvent refinements (latest)
...
### Current and candidates rule
- `current.resources` = active now
- `candidates` = full applicable re-decision set, including the currently active resources
