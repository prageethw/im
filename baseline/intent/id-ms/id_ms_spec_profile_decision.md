...
- [5. Consumer-submitted DRAFT creation profile:](#5-consumer-submitted-draft-creation-profile)
  - [5.1 Minimum mandatory fields for DRAFT creation:](#51-minimum-mandatory-fields-for-draft-creation)
  - [5.2 Strongly recommended fields for DRAFT creation:](#52-strongly-recommended-fields-for-draft-creation)
  - [5.3 Optional fields for DRAFT creation:](#53-optional-fields-for-draft-creation)
- [6. Consumer-submitted ACTIVE publication profile:](#6-consumer-submitted-active-publication-profile)
  - [6.1 Minimum mandatory fields for ACTIVE publication:](#61-minimum-mandatory-fields-for-active-publication)
  - [6.2 Strongly recommended fields for ACTIVE publication:](#62-strongly-recommended-fields-for-active-publication)
  - [6.3 Optional fields for ACTIVE publication:](#63-optional-fields-for-active-publication)
