...
- Do not include `lifecycleStatus` by default; `lifecycleStatus` carries the assurance outcome.
...
- Raw telemetry remains outside IC MS; IC MS consumes curated assurance outcomes from IA MS.
