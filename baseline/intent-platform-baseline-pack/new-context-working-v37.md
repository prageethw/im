...
## Markdown baseline file manifest baseline

The current Markdown baseline manifest is captured in `markdown-baseline-file-manifest.md` and includes the current release set plus historical generated Markdown artifacts.
